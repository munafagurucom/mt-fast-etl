# Rust Integration Guide: Clickhouse Sink Connector

## Overview
Clickhouse Sink Connector is a specific variant or enterprise configuration connector mapping back to its core database architecture. This document explains how a Rust application can integrate and write data effectively to Clickhouse Sink Connector.
...
## Pros & Cons
### Pros
- Fast natively enhanced by Rust's zero-cost abstractions.

### Cons
- Batch heavy natively in the Rust ecosystem.
