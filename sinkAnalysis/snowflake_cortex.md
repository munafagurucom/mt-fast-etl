# Rust Integration Guide: Snowflake Cortex

## Overview
Snowflake Cortex is a specific variant or enterprise configuration connector mapping back to its core database architecture. This document explains how a Rust application can integrate and write data effectively to Snowflake Cortex.
