# Rust Integration Guide: Mysql Strict Encrypt

## Overview
Mysql Strict Encrypt is a specific variant or enterprise configuration connector mapping back to its core database architecture. This document explains how a Rust application can integrate and write data effectively to Mysql Strict Encrypt.
...
## Pros & Cons
### Pros
- Ubiquitous natively enhanced by Rust's zero-cost abstractions.

### Cons
- Locking issues natively in the Rust ecosystem.
